# Insights for Smarter Production and Inventory Management(Created using MS Excel & Tableau)
...
## Dataset
https://github.com/JJAnalytics/Production-Inventory-Insights/blob/main/ebay_mens_perfume.csv
